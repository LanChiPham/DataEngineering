...
def functionkeywordArguments(karnatakaCapital, tamilNaduCapital, andraCapital):
    print ("karnataCapital = {0}".format(karnatakaCapital))
...
arbitraryKeywordArguments(child1 = "Sebastian", child2 = "Andrew", child3 = "Mahnohar")

# function with default value 
def printCountryName(country = "Vietnam"):
